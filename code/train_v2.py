...
from dataloader_v2 import Custom_Dataset_Multi, LRGB_GraphTask_Dataset, LRGB_NodeTask_Dataset, Heterophily_Dataset, Custom_Dataset_Single
        ...
        with torch.no_grad():
            ...
            if data.dataset_name in SINGLE_GRAPH_DATASETS:
                ...
                if args.eval_metric in ["AUCROC"]:
                    pred = torch.sigmoid(pred)[n_ids].squeeze(-1)
                    y = y.squeeze(-1)
