...
from constants_v2 import NODE_FEAT_TYPE_DICT, EDGE_FEAT_TYPE_DICT
...
class Heterophily_Dataset(Custom_Dataset_Single):
    ...
    def parse(self) -> Dict[str, Any]:
        ...
        if data_dict["num_class"] == 2:
            data_dict["num_class"] = 1
            data_dict["y"] = np.expand_dims(y, axis = 1).astype(float)
